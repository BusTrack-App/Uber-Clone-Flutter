...
class DriverHistoryTripItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          // Header - UserCard del Cliente
          Padding(
            padding: const EdgeInsets.all(16),
            child: UserCard(
              name: clientRequest.client.name,
              lastname: clientRequest.client.lastname,
              phone: clientRequest.client.phone,
              imageUrl: clientRequest.client.image,
            ),
          ),
                  ...
                  child: Column(
                    children: [
                      _buildDateRow(
                        ...
                        'Inicio',
                        _formatDate('${clientRequest.createdAt}'),
                      ),
  ...
  String _calculateDuration() {
    ...
    try {
      final DateTime start = DateTime.parse(
        clientRequest.createdAt!.toString(),
      );
